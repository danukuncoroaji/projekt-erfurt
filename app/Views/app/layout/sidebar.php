        ...
        <ul class="accordion-menu">
            ...
            <?php if ($session->get('level') == 3) { ?>
                <li <?php if (str_contains(base_url(uri_string()), 'pengaduan')) { ?> class="active-page" <?php } ?>>
                    <a href="#"><i class="material-icons-two-tone">forum</i>Pengaduan<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                    <ul class="sub-menu">
                        <li>
            ...
            <?php } else if ($session->get('level') == 1 || $session->get('level') == 2) { ?>
                <li <?php if (str_contains(base_url(uri_string()), 'pengumuman')) { ?> class="active-page" <?php } ?>>
                    <a href="#"><i class="material-icons-two-tone">announcement</i>Pengumuman<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                    <ul class="sub-menu">
                        <li>
            ...
            <?php if ($session->get('level') == 1) { ?>
                <li <?php if (str_contains(base_url(uri_string()), 'user')) { ?> class="active-page" <?php } ?>>
                    <a href="#"><i class="material-icons-two-tone">more_vert</i>Kategori<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                    <ul class="sub-menu">
                        <li>
            ...
            <?php if ($session->get('level') == 1) { ?>
                <li <?php if (str_contains(base_url(uri_string()), 'user')) { ?> class="active-page" <?php } ?>>
                    <a href="#"><i class="material-icons-two-tone">group</i>User<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                    <ul class="sub-menu">
                        <li>
